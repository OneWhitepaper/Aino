...
def _main_model_pin() -> Tuple[Optional[str], Optional[str]]:
    ...
    require_persistent_model_authority(provider)
...
def create_job(
    ...
    from agent.auxiliary_billing_scope import require_persistent_model_authority
    require_persistent_model_authority(f["provider"], no_agent=f["no_agent"], from_session=True)
...
def update_job(job_id: str, updates: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    def apply(jobs, i, job):
        ...
        if {"provider", "model", "base_url", "no_agent"}.intersection(updates):
            from agent.auxiliary_billing_scope import require_persistent_model_authority
            require_persistent_model_authority(
                updated.get("provider"), no_agent=bool(updated.get("no_agent")), from_session=True)
