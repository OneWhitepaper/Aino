...
/* eslint-disable */
// ── Types ──
export interface ManagedModelTicketParams {
  session_id: string
  profile?: string | null
  owner: PlatformOwner
  model_id: string
...
export interface ManagedModelTicketResult {
  session_ticket: string
  managed_model_binding: number
}
export interface ClaimManagedModelParams {
  session_id: string
  profile?: string | null
  owner: PlatformOwner
  model_id: string
...
export interface ClaimManagedModelResult {
  binding_revision: number
  managed_model_binding: number
}
export interface BindManagedModelParams {
  session_id: string
  profile?: string | null
  owner: PlatformOwner
  model_id: string
...
export interface BindManagedModelResult {
  bound: boolean
  model_id: string
  binding_revision: number
}
export interface ClearManagedModelParams {
  session_id: string
  profile?: string | null
  binding_revision: number
}
export interface ClearManagedModelResult {
  cleared: boolean
}
...
export interface AccountRequestCodeParams {
  profile?: string | null
  identifier: string
}
export interface AccountRequestCodeResult {
  ok: boolean
  delivery: 'development'
  expires_in: number
  retry_after: number
}
export interface AccountVerifyCodeParams {
  profile?: string | null
  identifier: string
  code: string
}
export interface AccountVerifyCodeResult {
  authenticated: boolean
  account: AccountPublic | null
  mode: 'development' | 'unconfigured'
  capabilities: AccountCapabilities
...
export interface SessionLiveInfo {
  ...
  platform_owner?: Record<string, string> | null
...
export interface ModelOptionsResult {
  ...
  model?: string
  provider?: string
  session_info?: SessionLiveInfo | null
}
...
export interface ProjectTreeNode {
  ...
  sessionIdentities?: ProjectTreeSessionIdentity[]
}
...
export interface ProjectTreeSessionIdentity {
  id: string
  _lineage_root_id?: string | null
  profile: string
}
...
export interface GatewayReadyPayload {
  ...
  managed_model_binding?: number | null
}
...
export interface TurnMetrics {
  ...
  context_max?: number | null
  context_estimated?: boolean | null
  non_aino_model_calls?: boolean | null
  billing?: ReplyBilling | null
}
export interface ReplyBilling {
  source: 'aino'
  user_id: string
  session_id: string
  turn_id: string
  status: 'pending'
  calls?: ReplyBillingCall[]
  calls_complete?: boolean
  revision?: number
}
export interface ReplyBillingCall {
  call_id: string
  purpose: string
}
...
export interface SessionUsagePayload {
  usage?: Usage | null
  reply_billing?: ReplyBilling | null
  reply_non_aino_model_calls?: boolean | null
}
...
export interface RpcMethods {
  'account.logout': { params: ProfileParams; result: AccountStatusResult }
  'account.request_code': { params: AccountRequestCodeParams; result: AccountRequestCodeResult }
  'account.status': { params: ProfileParams; result: AccountStatusResult }
  'account.update_profile': { params: AccountUpdateProfileParams; result: AccountStatusResult }
  'account.verify_code': { params: AccountVerifyCodeParams; result: AccountVerifyCodeResult }
  ...
  'session.bind_managed_model': { params: BindManagedModelParams; result: BindManagedModelResult }
  ...
  'session.claim_managed_model': { params: ClaimManagedModelParams; result: ClaimManagedModelResult }
  'session.clear_managed_model': { params: ClearManagedModelParams; result: ClearManagedModelResult }
  ...
  'session.managed_model_ticket': { params: ManagedModelTicketParams; result: ManagedModelTicketResult }
  ...
  'session.renew_managed_model': { params: BindManagedModelParams; result: BindManagedModelResult }
