...
function PaneClippedContent({
  ...
  return (
    <TooltipPrimitive.Content
      ...
      className={cn(
        'pointer-events-none z-(--z-over-modal) w-fit select-none',
        variant === 'card'
          ? 'max-w-72 rounded-(--aino-radius-panel) border border-(--stroke-nous) bg-(--ui-bg-elevated) text-foreground shadow-nous'
          : 'tooltip-bubble bg-foreground px-2 py-1 text-[length:var(--aino-text-caption)] font-medium leading-[1.4] text-background',
        className
      )}
