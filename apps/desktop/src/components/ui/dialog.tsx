...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      className={cn(
        'fixed inset-0 z-(--z-modal-backdrop) pointer-events-auto bg-(--aino-scrim) data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:animate-in data-[state=open]:fade-in-0',
