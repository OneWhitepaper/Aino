...
/** Compatibility constant retained for upstream callers that render the
 * untyped placeholder directly. New UI code should use newSessionTitle() so
 * the active locale is honored. */
