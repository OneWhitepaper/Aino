...
describe('the Bots pane dock', () => {
  ...
  it('keeps the Agent Hub tab consistent with its product name across locales', () => {
    paneStores()
    ...
    expect(inLocale('ru')).toBe(harness.find('pane')!.title)
    expect(inLocale('en')).toBe(harness.find('pane')!.title)
