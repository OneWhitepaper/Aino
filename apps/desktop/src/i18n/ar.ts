...
export const ar = defineLocale({
  ...
  settings: {
    ...
    account: {
      ...
      editDisplayName: 'تعديل الاسم',
      displayNameHint: 'من 1 إلى 32 حرفًا، ويظهر في الشريط الجانبي.',
      displayNameSaved: 'تم تحديث الاسم.',
      accountIdLabel: 'معرّف الحساب',
      loadingStatus: 'جارٍ الاتصال بخدمة الحساب…',
      refresh: 'إعادة المحاولة',
      serviceUnavailable: 'لم تُضبط خدمة الحساب بعد. اضبطها ثم أعد المحاولة.',
      termsRequired: 'يرجى الموافقة على الشروط وسياسة الخصوصية أولاً.',
      legalDevelopmentNotice:
        'هذه نسخة تطوير محلية. لم تُنشر الشروط وسياسة الخصوصية النهائية بعد. هذا الإشعار لاختبار تسجيل الدخول وليس اتفاقاً ملزماً. تُحفظ الحسابات التجريبية على الخادم المتصل، ولا تُرسل رسائل نصية أو بريد إلكتروني.',
      developmentCodeFor: 'الحساب التجريبي',
      errors: {
        invalid_identifier: 'أدخل بريداً إلكترونياً أو رقم هاتف صالحاً.',
        missing_code: 'اطلب رمزاً أولاً ثم أدخله لتسجيل الدخول.',
        invalid_code: 'الرمز غير صحيح. حاول مجدداً.',
        expired: 'انتهت صلاحية الرمز. اطلب رمزاً جديداً.',
        attempts_exceeded: 'محاولات خاطئة كثيرة. اطلب رمزاً جديداً.',
        development_disabled: 'لم تُضبط خدمة الحساب بعد.',
        retry_cooldown: 'انتظر قليلاً قبل طلب رمز آخر.',
        state_unavailable: 'تعذرت قراءة معلومات الحساب أو حفظها. أعد المحاولة.',
        invalid_display_name: 'أدخل اسمًا من 1 إلى 32 حرفًا دون فواصل أسطر.',
        not_authenticated: 'سجّل الدخول قبل تغيير الاسم.',
        unavailable: 'تعذر الاتصال بخدمة الحساب. تحقق من اتصالك.'
      },
      title: 'حسابي',
      signInTitle: 'تسجيل الدخول إلى Aino',
      signInDescription: 'سجل الدخول بالبريد أو الهاتف. يُنشأ الحساب عند أول تحقق.',
      codeTitle: 'أدخل رمز التحقق',
      codeDescription: 'أدخل الرمز المرسل إلى وسيلة الاتصال.',
      identifierLabel: 'البريد الإلكتروني أو الهاتف',
      identifierPlaceholder: 'رقم الهاتف أو البريد الإلكتروني',
      ...
      resendIn: seconds => `إعادة الإرسال بعد ${seconds}ث`,
      signOut: 'تسجيل الخروج',
      signedInDescription: 'عرض معلومات حساب Aino الذي سجلت الدخول إليه.',
      developmentHint: 'للتطوير: استخدم الرمز 1234. لا تُرسل رسائل نصية أو بريد إلكتروني.',
      termsLabel: 'الموافقة على اتفاقية المستخدم وسياسة الخصوصية',
      termsPrefix: 'قرأت ووافقت على',
      terms: 'اتفاقية المستخدم',
      and: 'و',
      privacy: 'سياسة الخصوصية',
      switchWechat: 'التبديل إلى تسجيل WeChat',
      codeSentTo: 'تم إرسال الرمز إلى',
      wechatTitle: 'تسجيل الدخول عبر WeChat',
      wechatUnavailable: 'تسجيل WeChat غير متاح في إصدار التطوير هذا.',
      switchIdentifier: 'التبديل إلى البريد / الهاتف'
    },
    plugins: {
    ...
    appearance: {
      title: 'المظهر',
      intro: 'إعدادات العرض في Aino Desktop.',
  ...
  profiles: {
    ...
    advanced: 'مساحات العمل المتقدمة',
  ...
  sidebar: {
    sessionOptions: 'خيارات المحادثات',
    gatewayGroups: {
    ...
    projects: {
      ...
      setPrimaryFolder: 'تعيين كمجلد أساسي',
      foldersDescription: 'تستخدم المحادثات الجديدة المجلد الأساسي. إزالة الارتباط تبقي الملفات والمحادثات.',
      ...
      unavailableAllProfiles: 'إعدادات المشاريع للقراءة فقط عند عرض الكل. اختر مساحة العمل من الإعدادات للتعديل.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      startProjectChat: 'بدء محادثة جديدة في مشروع',
  ...
  updates: {
    ...
    changelog: {
      ...
      fallbackItem: 'تحسينات وإصلاحات',
      fallbackLabel: 'في هذا التحديث'
    }
  },
  guidedGreeting: {
  ...
  shell: {
    ...
    statusbar: {
      subtaskMonitor: 'مراقبة المهام الفرعية',
      systemResources: {
        backendHost: 'مضيف البوابة الحالية',
        unavailable: 'موارد النظام غير متاحة',
        title: 'موارد النظام',
        loading: 'الموارد',
        gpuUtilization: 'استخدام GPU',
        gpuMemory: 'ذاكرة GPU',
        ram: 'ذاكرة النظام',
        unifiedNote: 'ذاكرة مشتركة بين GPU والنظام.',
        toggle: 'موارد النظام'
      },
      unknown: 'غير معروف',
      restart: 'إعادة تشغيل',
  ...
  rightSidebar: {
    ...
    terminalStartFailed: (error: string) => `فشل تشغيل الطرفية: ${error}`,
  ...
  assistant: {
    thread: {
      ...
      replyMetrics: {
        ...
        tokens: 'الاستهلاك',
        context: 'السياق',
        cache: 'إصابة التخزين المؤقت',
        details: 'تفاصيل استهلاك الرد',
        sessionElapsed: 'مدة المحادثة حتى هذا الرد',
        input: 'الإدخال',
        output: 'الإخراج'
      },
  ...
  desktop: {
    ...
    attachmentReadFailed: (label: string) => `تعذّرت قراءة المرفق: ${label}`,
    attachmentAttachFailed: (label: string) => `تعذّر إرفاق المرفق: ${label}`,
