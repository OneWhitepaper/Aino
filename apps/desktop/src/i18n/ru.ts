...
export const ru = defineLocale({
  ...
  settings: {
    ...
    account: {
      ...
      displayNameHint: 'От 1 до 32 символов. Отображается на боковой панели.',
      displayNameSaved: 'Имя обновлено.',
      accountIdLabel: 'ID аккаунта',
      loadingStatus: 'Подключение к сервису аккаунтов…',
      refresh: 'Повторить',
      serviceUnavailable: 'Сервис аккаунтов не настроен. Настройте его и повторите попытку.',
      termsRequired: 'Подтвердите согласие с условиями и политикой конфиденциальности.',
      legalDevelopmentNotice:
        'Это локальная версия для разработки. Окончательные условия и политика конфиденциальности ещё не опубликованы. Это уведомление служит для тестирования входа и не является договором. Тестовые аккаунты хранятся на подключённом сервере; SMS и письма не отправляются.',
      developmentCodeFor: 'Тестовый аккаунт',
      errors: {
        invalid_identifier: 'Введите корректный адрес почты или номер телефона.',
        missing_code: 'Сначала запросите код, затем введите его.',
        invalid_code: 'Неверный код. Попробуйте ещё раз.',
        expired: 'Срок действия кода истёк. Запросите новый.',
        attempts_exceeded: 'Слишком много попыток. Запросите новый код.',
        development_disabled: 'Сервис аккаунтов не настроен.',
        retry_cooldown: 'Подождите перед повторным запросом.',
        state_unavailable: 'Не удалось прочитать или сохранить данные аккаунта. Повторите попытку.',
        invalid_display_name: 'Введите имя длиной от 1 до 32 символов без переноса строк.',
        not_authenticated: 'Войдите, чтобы изменить имя.',
        unavailable: 'Нет связи с сервисом аккаунтов. Проверьте подключение.'
      },
      title: 'Мой аккаунт',
      signInTitle: 'Войти в Aino',
      signInDescription: 'Войдите по почте или телефону. Первая проверка создаёт аккаунт.',
      codeTitle: 'Введите код подтверждения',
      codeDescription: 'Введите код, отправленный на ваш контакт.',
      identifierLabel: 'Почта или телефон',
      identifierPlaceholder: 'Телефон или электронная почта',
      ...
      resendIn: seconds => `Повтор через ${seconds} с`,
      signOut: 'Выйти',
      signedInDescription: 'Информация о вашем аккаунте Aino.',
      developmentHint: 'Тестирование: код 1234. SMS и письма не отправляются.',
      termsLabel: 'Согласие с пользовательским соглашением и политикой конфиденциальности',
      termsPrefix: 'Я прочитал(а) и согласен(на) с',
      terms: 'пользовательским соглашением',
      and: 'и',
      privacy: 'политикой конфиденциальности',
      switchWechat: 'Войти через WeChat',
      codeSentTo: 'Код отправлен на',
      wechatTitle: 'Вход через WeChat',
      wechatUnavailable: 'Вход через WeChat недоступен в этой сборке для разработки.',
      switchIdentifier: 'Войти по почте / телефону'
    },
    plugins: {
    ...
    appearance: {
      title: 'Внешний вид',
      intro: 'Настройки отображения Aino Desktop.',
      colorMode: 'Цветовой режим',
      colorModeDesc: 'Выберите светлый или тёмный режим либо следуйте настройкам системы.',
  ...
  sidebar: {
    sessionOptions: 'Параметры чатов',
    gatewayGroups: {
  ...
  shell: {
    ...
    statusbar: {
      subtaskMonitor: 'Монитор подзадач',
      systemResources: {
        backendHost: 'Хост текущего шлюза',
        unavailable: 'Ресурсы системы недоступны',
        title: 'Ресурсы системы',
        loading: 'Ресурсы',
        gpuUtilization: 'Загрузка GPU',
        gpuMemory: 'Память GPU',
        ram: 'Оперативная память',
        unifiedNote: 'Общая память GPU и системы.',
  ...
  assistant: {
    thread: {
      ...
      replyMetrics: {
        ...
        context: 'Контекст',
        cache: 'Кэш',
        details: 'Статистика ответа',
        sessionElapsed: 'Время сессии к этому ответу',
        input: 'Вход',
        output: 'Выход'
      },
