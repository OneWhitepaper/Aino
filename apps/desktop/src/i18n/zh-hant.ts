...
export const zhHant = defineLocale({
  platformRechargeErrors: {
    ...
    disabled: '目前儲值渠道無法使用。已有訂單仍可在儲值記錄中查詢。',
    retry: '登入已恢復，請再次點擊操作。系統未自動重複下單。',
    expired: '付款碼已過期，請重新整理訂單確認付款結果。'
  },
  platformDevices: {
    title: '裝置授權',
    refresh: '重新整理裝置',
    ...
    revoke: '撤銷',
    confirmTitle: '撤銷裝置授權？',
    confirmDescription: '此裝置上的平台模型任務可能中斷，登入工作階段也將失效。',
    stepUp: '請輸入驗證器中的驗證碼以繼續。',
    code: '驗證器驗證碼',
    verify: '驗證',
    reauthenticate: '請登出並重新登入，再撤銷此裝置授權。',
    success: '裝置授權已撤銷',
    failed: '無法撤銷裝置授權。'
  },
  sessionImport: {
  ...
  platformUsage: {
    ...
    settled: '本回合費用',
    unverified: '費用尚未核實',
    unavailable: '暫時無法查詢費用',
    signIn: '登入原帳戶後查看費用',
    retry: '重新核對',
    details: '查看明細',
    empty: '暫無結算紀錄',
    truncated: '僅顯示前 200 筆紀錄，費用尚未全部核實',
    recordSettled: '已結算',
    notCharged: '不計費',
    purposes: {
      chat: '對話',
      ...
      vision: '圖像理解',
      delegation: '子任務',
      session_summary: '對話摘要',
      approval: '操作核准判斷',
      mcp: 'MCP 模型呼叫',
      tts_audio_tags: '語音表達標註',
      side_question: '旁支問答',
      other_auxiliary: '輔助呼叫（未細分）'
    }
  },
  platformWallet: {
    title: 'Aino 錢包',
    ...
    unlimited: '不限額',
    expires: '到期時間',
    paymentDisabled: '儲值暫未開放'
  },
  platformRecharge: {
    title: '儲值',
    description: '入帳金額以平台帳本為準。',
    amount: '儲值金額',
    range: '單筆限額',
    quote: '查看報價',
    create: '確認建立訂單',
    ...
    newOrder: '新增儲值',
    success: '儲值成功',
    confirmingBalance: '訂單已完成，正在核對餘額',
    changedQuote: '最終金額有所變更，請確認後付款。',
    confirmPrice: '確認最終金額',
    unknown: '訂單結果待確認，請繼續恢復原訂單，勿重複付款。',
    resume: '恢復原訂單',
    unavailable: '目前沒有可用儲值管道',
    error: '暫時無法完成操作，請重試或從訂單紀錄恢復。',
    methods: { alipay: '支付寶', wxpay: '微信支付' },
    status: {
      PENDING: '等待付款',
      PAID: '已付款，正在入帳',
      RECHARGING: '已付款，正在入帳',
  ...
  platformBillingHistory: {
    ...
    endDate: '結束日期',
    model: '模型',
    modelPlaceholder: '輸入完整模型名稱',
    purpose: '呼叫用途',
    allPurposes: '所有用途',
    search: '查詢',
    reset: '重設',
    invalidDateRange: '開始日期不能晚於結束日期。',
    timezone: zone => `本機時區：${zone}`,
    totalRecords: count => `共 ${count} 筆`,
    pageSize: '每頁筆數',
    goToPage: page => `第 ${page} 頁`,
    jumpToPage: '跳至頁碼',
    jump: '跳轉',
    noMatches: '沒有符合篩選條件的消費紀錄',
    columns: { time: '呼叫時間', model: '模型', purpose: '呼叫用途', cost: '費用（USD）', status: '結算狀態' },
    details: '查看詳情',
    hideDetails: '收起詳情',
    copyField: label => `複製${label}`,
    requestId: '請求 ID',
    sessionId: '對話 ID',
    turnId: '回合 ID',
    callId: '呼叫 ID',
    ...
    unknown: '未記錄',
    unknownPurpose: '用途未記錄',
    unclassifiedHelp: '部分歷史紀錄未細分，或呼叫時未記錄具體用途，無法可靠還原為某一類呼叫。'
  },
  platformModels: {
    ...
    myAccount: '我的帳戶',
    chooseCustom: '選擇自訂模型',
    recoveryFor: model => `${model} 復原操作`,
    unavailable: '模型無法使用',
    empty: '此帳戶暫無可用模型',
    catalogError: '無法載入 Aino 模型',
    balance: 'Aino 餘額',
    subscription: '訂閱額度',
    insufficient_balance: '餘額不足',
    quota_exhausted: '額度已用完',
    details: '價格與能力',
    input: '輸入',
    output: '輸出',
    cacheRead: '快取讀取',
    ...
    historyReadOnly: (owner: string) =>
      `此對話屬於原 Aino 帳戶 ${owner}。可以查看本機歷史，但不能使用目前帳戶繼續傳送。`,
    newChatCurrentAccount: '使用目前帳戶建立新對話',
    followCustom: '使用自訂模型預設設定',
    defaultTag: '預設',
    not_authenticated: '請先登入 Aino 再使用此模型',
    platform_account_changed: '此模型屬於其他帳戶。請登入原帳戶或重新選擇模型。',
    bindingFailed: '模型授權失敗，訊息尚未傳送。請重新選擇模型後重試。',
    unsupported: '此連線不支援 Aino 內建模型',
    rate: '帳戶倍率',
    tiers: '階梯價格',
    timePricing: '分時價格',
    groupPeak: '尖峰價格',
  ...
  settings: {
    ...
    account: {
      displayNameLabel: '暱稱',
      editDisplayName: '修改暱稱',
      displayNameHint: '1–32 個字元，將顯示在左下角。',
      displayNameSaved: '暱稱已更新。',
      accountIdLabel: '帳戶 ID',
      loadingStatus: '正在連線至帳戶服務…',
      refresh: '重試',
      ...
      registrationClosed: '註冊暫未開放。',
      phoneAutoRegister: '尚未註冊的手機號碼驗證成功後會自動註冊。',
      phoneLoginUnavailable: '手機號碼登入暫未開放，請使用現有帳戶登入。',
      existingAccountPhoneHint: '已有網站帳戶？請先登入原帳戶，再綁定手機號碼。',
      registrationReturnHint: '註冊完成後，使用相同電子郵件和密碼登入。網站與桌面共用一個帳戶。',
      registrationOpenFailed: '無法開啟註冊頁面，請重試。',
      emailLabel: '電子郵件',
      ...
      errors: {
        ...
        invalid_code: '驗證碼不正確，請重新輸入。',
        expired: '驗證碼已過期，請重新取得。',
        attempts_exceeded: '錯誤次數過多，請重新取得驗證碼。',
        development_disabled: '帳戶服務尚未設定。',
        retry_cooldown: '請稍後再取得驗證碼。',
      ...
      title: '我的帳戶',
      signInTitle: '登入 Aino',
      signInDescription: '使用電子郵件或手機號碼登入，首次驗證成功會自動註冊。',
      codeTitle: '輸入驗證碼',
      codeDescription: '輸入傳送到聯絡方式的驗證碼以繼續。',
      identifierLabel: '電子郵件或電話號碼',
      identifierPlaceholder: '支援手機號碼／電子郵件',
      codeLabel: '驗證碼',
      ...
      signOut: '登出',
      signedInDescription: '檢視你目前登入的 Aino 帳戶資料。',
      developmentHint: '開發測試：驗證碼 1234，不會發送簡訊或郵件。',
      termsLabel: '同意使用者協議與隱私權政策',
      termsPrefix: '我已閱讀並同意',
      terms: '使用者協議',
      and: '和',
      privacy: '隱私權政策',
    ...
    model: {
      ...
      tasks: {
        ...
        session_summary: { label: '內容摘要', hint: '透過 API 按需請求的工作階段摘要' },
  ...
  shell: {
    ...
    statusbar: {
      ...
      turnRunning: '執行中',
      contextUsage: '上下文使用量',
      subtaskMonitor: '子任務監控',
      systemResources: {
        backendHost: '目前閘道所在主機',
        unavailable: '暫時無法取得系統資源',
        title: '系統資源',
        loading: '資源…',
  ...
  assistant: {
    thread: {
      ...
      replyMetrics: {
        ...
        context: '上下文',
        cache: '快取命中',
        nonAinoModelCalls: '此回覆使用了 Aino 以外的模型呼叫。',
        details: '回覆消耗詳情',
      ...
      sendEdited: '傳送編輯後的訊息',
      attachingFile: '正在附加…',
      messaging: target => `正在向 ${target} 傳送訊息`,
      messaged: target => `已向 ${target} 傳送訊息`,
      messageFrom: sender => `來自 ${sender} 的訊息`,
      repliedTo: sender => `已回覆 ${sender}`,
      showMessage: '顯示訊息',
      showReply: '顯示回覆',
      output: '輸出'
    },
  ...
  desktop: {
    ...
    platformVisionUnsupported: '此 Aino 模型不支援圖片。請選擇支援圖片的模型；草稿與附件已保留。',
    chooseModel: '選擇模型',
    ...
    resumeRetry: '重試',
    sessionStillAvailableRetry: '工作階段仍然可用，請重試繼續。',
    sessionUnavailableRetry: '工作階段不可用，你可以重試繼續。',
  ...
  ui: {
    ...
    messages: {
      embedLoadFailed: label => `無法載入 ${label} 嵌入內容`,
      noPageAt: path => `${path} 沒有對應頁面`
    },
    routes: {
      artifacts: '成品',
      messaging: '訊息平台',
