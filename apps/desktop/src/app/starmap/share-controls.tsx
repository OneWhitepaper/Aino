      ...
      >
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="group/code relative">
            <Textarea
              aria-label={t.starmap.shareTitle}
              className="h-24 resize-none pr-9 font-mono leading-relaxed break-all"
              onChange={e => {
            ...
            {code !== '' && (
              <CopyButton
                appearance="inline"
                className="absolute right-1.5 top-1.5 opacity-0 transition-opacity focus-visible:opacity-100 group-hover/code:opacity-100 hover:opacity-100"
