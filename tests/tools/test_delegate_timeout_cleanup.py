...
def test_timeout_does_not_close_child_while_worker_is_unwinding(monkeypatch):
    # Real agents load tools before delegation; cold discovery must not consume
    # the synthetic child's deadline for waiting on the test's release signal.
