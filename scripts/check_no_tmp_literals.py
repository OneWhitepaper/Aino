...
_BASELINE: dict[str, int] = {
    # Aino's pre-existing validation receipts record actual historical evidence paths.
    # Preserve those locations; these exact counts still reject newly added literals.
    "design-qa.md": 11,
    "docs/implementation/aino-platform-acceptance-matrix.md": 8,
    "docs/implementation/aino-platform-account-edges-validation-20260917.json": 2,
    "docs/implementation/aino-platform-b4-review.md": 1,
    "docs/implementation/aino-platform-b5-review.md": 2,
    "docs/implementation/aino-platform-claude-handoff.md": 2,
    "docs/implementation/aino-platform-delivery.md": 11,
    "docs/implementation/aino-platform-local-release-gates.md": 2,
    "docs/implementation/aino-platform-progress.md": 19,
    "docs/implementation/aino-platform-python-fixtures.md": 5,
    "docs/implementation/aino-platform-quality-review.md": 4,
    "docs/implementation/aino-platform-sqlite-recovery-20260917.md": 19,
